...
class SearchingTests(unittest.TestCase):
    ...
    def test_binary_search(self):
        ...
        # self.assertEqual(binary_search(arr1, 0, len(arr1)-1, -8), 1)
        # self.assertEqual(binary_search(arr1, 0, len(arr1)-1, 0), 6)
        # self.assertEqual(binary_search(arr2, 0, len(arr2)-1, 6), -1)
        # self.assertEqual(binary_search(arr2, 0, len(arr2)-1, 0), -1)
